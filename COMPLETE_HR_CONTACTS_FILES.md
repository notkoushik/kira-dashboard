# HR CONTACTS INTEGRATION - COMPLETE FILE CONTENTS

## ALL COMPLETE FILE CONTENTS FOR REFERENCE

---

# BACKEND

## File 1: src/index.ts (Route Mounting)
...
## File 2: src/routes/hrcontacts.ts (184 lines)
...
## File 3: src/services/HRContactService.ts (169 lines)
...
## File 4: kira-frontend/index.html (UPDATED SECTIONS)

### SECTION 1: APIClient - Added HR Contacts Methods

**Location: Around line 1137-1170**

```javascript
    getJobStats: () => apiCall('/jobs/stats/summary'),
...
### SECTION 2: Updated submitHR() Function

**Location: Around line 1873**
...
### SECTION 3: Updated deleteHR() Function

**Location: Around line 1902**
...
### SECTION 4: Updated sendEmail() Function

**Location: Around line 1933**
...
### SECTION 5: Updated saveDraft() Function

**Location: Around line 1941**
...
### SECTION 6: Updated loadData() Function

**Location: Around line 2053**
...
**Backend:**
- ✅ Route file: 184 lines
- ✅ Service file: 169 lines  
- ✅ Mounted in index.ts
- ✅ All 7 CRUD endpoints

**Frontend:**
- ✅ 5 sections updated
- ✅ APIClient: 5 new methods
- ✅ submitHR(): Uses APIClient (create/update)
- ✅ deleteHR(): Uses APIClient
- ✅ sendEmail(): Uses APIClient
- ✅ saveDraft(): Uses APIClient  
- ✅ loadData(): Fetches from API (not localStorage)
